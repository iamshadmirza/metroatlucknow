...
<body>
  ...
  <div class="body"></div>
		<div class="grad"></div>
		<div class="header">
			<div>Account <span>Registration</span></div>
		</div>
		<br>
		<form action="insertreg.jsp" method="post">
		<div class="login">
				<input type="text" placeholder="full name" name="fullname"><br>
				<input type="text" placeholder="username" name="username"><br>
				<input type="text" placeholder="age" name="userage"><br>
				<input type="email" placeholder="email" name="useremail"><br>
				<input type="password" placeholder="password" name="userpassword"><br>
				<input type="password" placeholder="re-enter password" name="repassword"><br>
				<input type="submit" style="background-color:#d01717;" value="Signup">
		</div>
		</form>
