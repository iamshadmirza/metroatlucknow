...
<body>
  ...
  <div class="body"></div>
		<div class="grad"></div>
		<div class="header">
			<div>SmartCard <span>Application</span><br><br></div>
		</div>
		<br>
		
		<div class="login">
				<b>You can apply here to get you SmartCard</b></br>
				<b>Fill up the following details</b></br><br>
				<form action="insertcard.jsp" method="post">
				<input type="text" placeholder="Full Name" name="Fname"><br>
				<input type="text" placeholder="user name" name="Uname"><br>
				<input type="text" placeholder="Adhaar Number" name="Adhar"><br>
				<input type="text" placeholder="Current Address" name="Address"><br>
