...
<body>
  ...
  <div class="body"></div>
		<div class="grad"></div>
		<div class="header">
			<div>Account <span>LogIn</span></div>
		</div>
		<br>
		<form action="userlogin.jsp" method="post">
		<div class="login">
				<input type="text" placeholder="username" name="txtusername"><br>
				<input type="password" placeholder="password" name="txtuserpassword"><br>
				<input type="submit" style="background-color:#d01717;" value="Login">
		</div>
		</form>
